...
void Field::SetByteValue(const void* newValue, const size_t newSize, enum_field_types newType, vn::u32 length)
{
    if (data.value)
        CleanUp();
...
void Field::SetStructuredValue(char* newValue, enum_field_types newType, vn::u32 length)
{
    if (data.value)
        CleanUp();
