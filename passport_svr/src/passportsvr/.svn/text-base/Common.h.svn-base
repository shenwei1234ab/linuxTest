...
enum GAME_ID {
	...
	GAME_ID_Hat = 2, //草帽军团
	GAME_ID_GIRL = 3, //我的美女老师
	GAME_ID_GUN = 4, //天天枪战2（未来战场）
...
enum ERROR_CODE
	...
	ERROR_CODE_DB_ERROR = 36,                   //数据库异常

	ERROR_CODE_NET_ERROR = 37,                   //网络异常
};
...
//******************* 棱镜 ********************************************
const static std::string XINMEI365_CHANNEL = "302e12a8e9354f859a19b1c307166e3c";
const static std::string XINMEI365_TOKEN = "68626c00bff34a589c649f9053801c64";
const static std::string XINMEI365_PRODUCT_CODE = "p3021";
